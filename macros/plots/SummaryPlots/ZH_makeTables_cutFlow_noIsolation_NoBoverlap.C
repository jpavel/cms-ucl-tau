...
int MakeTable(bool useData = true)
{
  ...
  fileNames.push_back("53x/MC/NoBOverlap_DYJetsToLL_M-50_TuneZ2Star_8TeV-madgraph-tarball");
  								fileNames.push_back("53x/MC/NoBOverlap_WZJetsTo3LNu_TuneZ2_8TeV-madgraph-tauola");
								fileNames.push_back("52x/MC/NoBOverlap_TT");
								fileNames.push_back("53x/MC/NoBOverlap_TTZJets_8TeV-madgraph_v2");
								fileNames.push_back("53x/MC/NoBOverlap_ZZTo4L_TuneZ2star_8TeV_pythia6_tauola");
								fileNames.push_back("53x/MC/NoBoverlap_Htt120");
								fileNames.push_back("53x/MC/NoBoverlap_Hww120");
  if(useData) 					fileNames.push_back("53x/Data/NoBoverlap");
  ...
  for(int iFile = 0; iFile < nFiles; iFile++)
  {
   ...
   TString BinLabels2[4] = { "H selected", "Overlap cleaning", "Same vx", "B-tag veto"};
	...
	ofstream tab1;
	tab1.open("/home/jpavel/Documents/UCL/HiggsTauTau/ZH/cutflow/cutFlow_noIso_noB.tab");
		tab1 << "\\begin{sidewaystable}[h]" << std::endl;
	tab1 << "	\\begin{center}" << std::endl;
	tab1 << "		\\caption{event yield 2012 (noIsolation and no b-tau overlap) (12 fb$^{-1}$)}\\label{tab:CutFlow_noIso_noB}" << std::endl;
