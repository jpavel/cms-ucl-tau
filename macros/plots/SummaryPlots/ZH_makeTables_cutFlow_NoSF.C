...
int MakeTable(TString inputFile = "Htt125")
{
  ...
  TString fileNames[nFiles] = {"53x/MC/Standard_DYJetsToLL_M-50_TuneZ2Star_8TeV-madgraph-tarball",
								"53x/MC/Standard_WZJetsTo3LNu_TuneZ2_8TeV-madgraph-tauola",
								"52x/MC/Standard_TT",
								"53x/MC/Standard_TTZJets_8TeV-madgraph_v2",
								"53x/MC/Standard_ZZTo4L_TuneZ2star_8TeV_pythia6_tauola",
								"53x/MC/Standard_Htt120",
								"53x/MC/Standard_Hww120"
  };
  TString names[nFiles] = {"DYJets","WZJets","TT","TTZ","ZZ4L","Htt(120)","Hww(120)"};
  ...
  for(int iFile = 0; iFile < nFiles; iFile++)
  {
	...
	double xsec[nFiles] = {3503.7,1.057,23.64,0.208,0.130, productionXS*BRtau, productionXS*BRw};
   ...
   TString BinLabels2[4] = { "H selected", "Overlap cleaning", "Same vx", "B-tag veto"};
	...
	ofstream tab1;
	tab1.open("/home/jpavel/Documents/UCL/HiggsTauTau/ZH/cutflow/cutFlow_NoSF.tab");
		tab1 << "\\begin{sidewaystable}[h]" << std::endl;
	tab1 << "	\\begin{center}" << std::endl;
	tab1 << "		\\caption{event yield 2012 (no SF) (12 fb$^{-1}$)}\\label{tab:CutFlow_NoSF}" << std::endl;
