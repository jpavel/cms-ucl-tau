...
void ATLAS_PRELIMINARY_LABEL(Double_t x,Double_t y, Color_t color) 
{
  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
  l.SetNDC();
  l.SetTextFont(text_font_bold);
...
void ATLAS_MC_PRELIMINARY_LABEL(Double_t x,Double_t y, Color_t color) 
{
  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
  l.SetNDC();
  l.SetTextFont(text_font_bold);
...
void ATLAS_PRELIMINARY_LABEL_RATIO(Double_t x,Double_t y, Color_t color) 
{
  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
  l.SetNDC();
  l.SetTextFont(text_font_bold);
...
void myText(Double_t x,Double_t y,Color_t color,string text, Float_t tsize) {

  //Double_t tsize=0.05;
  TLatex l; //l.SetTextAlign(12); 
  if(tsize != -1) l.SetTextSize(tsize); 
  l.SetNDC();
...
void myBoxText(Double_t x, Double_t y,Double_t boxsize,Int_t mcolor, string text, Int_t mstyle) 
{
...
void myLineText(Double_t x, Double_t y,Double_t boxsize,Int_t mcolor,string text, int linestyle) 
{
...
void myMarkerText(Double_t x,Double_t y,Int_t color,Int_t mstyle,string text,Float_t msize) 
{
  Double_t tsize=0.06;
