...
int stack_upgrade_WH() {
  ...
  TString outputDir = "/home/jpavel/analysis/CMS/Plots/Stack/WH/20131014/WZJets";
 ...
 // TH1F *                signal[nHist1];
  ...
  Double_t xsection[nFiles]={1.0, 1.057, 1.057, 0.130};//, 0.208, 0.01203, 0.0048}; // pb
  Double_t events[nFiles]={1.0, 2979624, 2017979, 4989540};//, 210160, 400973, 548760}; // pb
  
  Color_t colors[nFiles]={kBlack,kRed,kRed,kBlue};
