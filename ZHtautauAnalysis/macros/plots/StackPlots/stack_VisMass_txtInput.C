...
int stack_upgrade() {
  ...
  TString inputDir = "/home/jpavel/analysis/CMS/histograms/PostMoriod/20130918/MySummary3/";
  
  TString outputDir = "/home/jpavel/analysis/CMS/Plots/Stack/PostMoriond/20130918_MVis";
...
//	   hs->Clear();    
  ...
  TFile out(outputROOTDir+"vhtt_llLL.inputsMVis-sm-8TeV.root","RECREATE");
