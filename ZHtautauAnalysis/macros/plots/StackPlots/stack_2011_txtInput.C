...
int stack_upgrade() {
  ...
  std::ifstream myfile;
  myfile.open ("BGinput_2011_v22.txt");	
  if (myfile.is_open()){
	while ( myfile.good() ){
		TString name;
		myfile >> name;
  ...
  datafile.open ("Datainput_2011_v22.txt");	
  if (datafile.is_open()){
	while ( datafile.good() ){
		TString name;
		datafile >> name;
  ...
  signalfile.open ("Signalinput_2011_v22.txt");	
  ...
  TString inputDir = "/home/jpavel/analysis/CMS/histograms/PostMoriod/20130918/MySummary2011_v2/";
  
  TString outputDir = "/home/jpavel/analysis/CMS/Plots/Stack/PostMoriond/20130918_2011_v2";
  ...
  TString tauESplusSuffix=	"ESplus";
  TString tauESminusSuffix=	"ESminus";
...
//~ 
 ...
 leg->SetBorderSize(0);
	  ...
	  leg->AddEntry(h_1d_data[iHist],"data 2011","p");   
...
//	   hs->Clear();    
  ...
  TFile out(outputROOTDir+"vhtt_llLL.inputsArmistice-sm-7TeV.root","RECREATE");
  ...
  TString nameUp="_7TeVUp";
  TString nameDown="_7TeVDown";
