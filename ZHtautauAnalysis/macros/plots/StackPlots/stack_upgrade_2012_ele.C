...
int stack_upgrade_42X() {
  ...
  //DoubleEle + WZjets 
  TString fileNames[nFiles] = {"DoubleEle",
  "20130130_AnalFull_2012MC_ZZTo4L_TuneZ2star_8TeV_pythia6_tauola/20130130_AnalFull_2012MC_ZZTo4L_TuneZ2star_8TeV_pythia6_tauola_histo",
  "20130130_AnalFull_2012MC_WZJetsTo3LNu_TuneZ2_8TeV-madgraph-tauola/20130130_AnalFull_2012MC_WZJetsTo3LNu_TuneZ2_8TeV-madgraph-tauola_histo",
  "20130130_AnalFull_2012MC_TTTo2L2Nu2B_8TeV-powheg-pythia6/20130130_AnalFull_2012MC_TTTo2L2Nu2B_8TeV-powheg-pythia6_histo",
  "20130130_AnalFull_2012MC_DYJetsToLL_M-50_TuneZ2Star_8TeV-madgraph-tarball/20130130_AnalFull_2012MC_DYJetsToLL_M-50_TuneZ2Star_8TeV-madgraph-tarball_histo",
  "20130130_AnalFull_2012MC_ZH_HToTauTau_M-125_lepdecay_8TeV-pythia6-tauola/20130130_AnalFull_2012MC_ZH_HToTauTau_M-125_lepdecay_8TeV-pythia6-tauola_histo",
  "20130130_AnalFull_2012MC_WH_ZH_TTH_HToWW_M-120_lepdecay_8TeV-pythia6/20130130_AnalFull_2012MC_WH_ZH_TTH_HToWW_M-120_lepdecay_8TeV-pythia6_histo"};
  //DoubleMu + WZ 
 ...
 //DoubleMu + WZ 
...

  {
	  ...
	  std::string input_file="Moriond/2012/"+indexes.str()+".root";
  ...
  TString PaveText[nHist1]	= {"CMS preliminary 2012","EEMT","EEME","EEET","EETT"};
  //~ 
  ...
  Double_t xsection[nFiles]={1.0, 0.130, 1.057, 23.64, 3503.7, 0.0025166466, 0.0033556098};
  
  
  
  const double total_lumi = 19431.784; //1294.0 +2741.0; // pb-1
  ...
  ll->AddText(0.5, 0.5, text);
	...
	// if(iHist > 0 && iHist < 4)  h_1d[iHist][0]->GetXaxis()->SetRangeUser(0,150);
	 ...
	 // signal[iHist]->Scale(10.);
	  ...
	  c1->SetLogy();	
	  c1->Print("Moriond/El_"+histNames1[iHist]+"_all.png");
	  c1->Print("Moriond/El_"+histNames1[iHist]+"_all.eps");
	  c1->SetLogy(0);
	  h_1d[iHist][0]->GetYaxis()->SetRangeUser(0,1.5*max);
	
	  c1->Print("Moriond/El_"+histNames1[iHist]+"_all_normal.png");
	  c1->Print("Moriond/El_"+histNames1[iHist]+"_all_normal.eps");
