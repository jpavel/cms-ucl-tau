...
int makePWhisto(TString filename_MC="/home/jpavel/ntuples/CMS/analysis/ZHtautau/Lucia/histo_42X_TruePU_v2/Htt125_42X_TruePU_1.root",TString filename_data="/home/jpavel/analysis/CMS/ZHtautau/ZHtautauAnalysis/config/dataPileUpHistogram_True_2011.root")
{
	gROOT->Reset();             
   SetAtlasStyle();
   gStyle->SetPalette(1);
