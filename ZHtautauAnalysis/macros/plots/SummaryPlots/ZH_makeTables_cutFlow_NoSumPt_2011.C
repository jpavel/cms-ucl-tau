...
int MakeTable(bool useData = true)
{
  ...
  fileNames.push_back("42x/MC/2011NoPtSum_DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola");
  								fileNames.push_back("42x/MC/2011NoPtSum_WZTo3LNu_TuneZ2_7TeV_pythia6_tauola");
								fileNames.push_back("42x/MC/2011NoPtSum_TTTo2L2Nu2B_7TeV-powheg-pythia6");
								fileNames.push_back("42x/MC/2011NoPtSum_ZZTo4L_TuneZ2_7TeV_pythia6_tauola");
								fileNames.push_back("42x/MC/2011NoPtSum_WH_ZH_TTH_HToTauTau_M-120_lepdecay_7TeV-pythia6-tauola_v2");
								fileNames.push_back("42x/MC/2011NoPtSum_WH_ZH_TTH_HToWW_M-120_lepdecay_7TeV-pythia6_v2");
  if(useData) 					fileNames.push_back("42x/Data/2011DataNoPtSum");
  ...
  for(int iFile = 0; iFile < nFiles; iFile++)
  {
   ...
   TString BinLabels2[4] = { "H selected", "Overlap cleaning", "Same vx", "B-tag veto"};
	...
	std::cout << "		\\caption{event yield 2011 (4.9 fb$^{-1}$)}\\label{tab:CutFlow}" << std::endl;
	...
	ofstream tab1;
	tab1.open("/home/jpavel/Documents/UCL/HiggsTauTau/ZH/cutflow/2011_cutFlow_NoSumPt_data.tab");
		tab1 << "\\begin{sidewaystable}[h]" << std::endl;
	tab1 << "	\\begin{center}" << std::endl;
	tab1 << "		\\caption{event yield 2011 (no LT cut) (4.9 fb$^{-1}$)}\\label{tab:CutFlow_NoSumPt}" << std::endl;
