...
do
  ...
  echo "echo \"source ShowResults.sh ${output_name}_${file}\" >> Show_${output_name}.sh" >> Prepare_${output_name}.sh
  echo "echo \"source MergeOutput.sh ${output_name}_${file} ${outDir}\" >> Merge_${output_name}.sh" >> Prepare_${output_name}.sh
