...
double Cor_FR_ID_Iso_Mu_Loose_2011(myobject const& a) {
...
double Cor_FR_ID_Iso_Mu_Tight_2011(myobject const& a) {
...
double Cor_FR_ID_Iso_Ele_Loose_2011(myobject const& a) {
...
double Cor_FR_ID_Iso_Ele_Tight_2011(myobject const& a) {
...
double Cor_FR_ID_Iso_Mu_Loose_2012(myobject const& a) {
...
double Cor_FR_ID_Iso_Mu_Tight_2012(myobject const& a) {
...
double Cor_FR_ID_Iso_Ele_Loose_2012(myobject const& a) {
...
double Cor_FR_ID_Iso_Ele_Tight_2012(myobject const& a) {
...
double Cor_FR_ID_Iso_Mu_Loose_2012_53X(myobject const& a) {
...
double Cor_FR_ID_Iso_Mu_Tight_2012_53X(myobject const& a) {
    if (a.pt > 17 && a.pt < 20 && fabs(a.eta) < 1.6) return 0.997*0.930;
    if (a.pt > 17 && a.pt < 20 && fabs(a.eta) > 1.6 && fabs(a.eta) < 2.1) return 0.986*0.929;
    if (a.pt > 20 && a.pt < 30 && fabs(a.eta) < 1.6) return 0.995*0.977;
    if (a.pt > 20 && a.pt < 30 && fabs(a.eta) > 1.6 && fabs(a.eta) < 2.1) return 0.986*0.984;
...
double Cor_FR_ID_Iso_Ele_Loose_2012_53X(myobject const& a) {
...
double Cor_FR_ID_Iso_Ele_Tight_2012_53X(myobject const& a) {
...
Double_t Eff_FR_HLT_Mu17_Mu8_2011_TPfit_RunAB_EtaEta_DATAoverMC(Double_t eta1, Double_t eta2) {
...
double Cor_FR_Trg_Mu_Lead_2011(myobject const& a) {
...
double Cor_FR_Trg_Mu_SubLead_2011(myobject const& a) {
...
double Cor_FR_Trg_Ele_Lead_2011(myobject const& a) {
...
double Cor_FR_Trg_Ele_SubLead_2011(myobject const& a) {
...
double Corr_FR_trigger_Mu17_Mu8_2011(myobject const& a1, myobject const& a2 )
{
	return Eff_FR_HLT_Mu17_Mu8_2011_TPfit_RunAB_EtaEta_DATAoverMC(a1.eta,a2.eta);
}

double Cor_FR_Total_Mu_Loose_2011(myobject const& a) {
    double cor_Id_Iso_Mu = Cor_FR_ID_Iso_Mu_Loose_2011(a);
...
double Cor_FR_Total_Mu_Tight_2011(myobject const& a) {
    double cor_Id_Iso_Mu = Cor_FR_ID_Iso_Mu_Tight_2011(a);
    //double cor_Trg_Mu = Eff_HLT_Mu17_Mu8_2011_TPfit_RunAB_EtaEta_DATAoverMC(a);
...
double Cor_FR_Total_Mu_Tight_2012(myobject const& a) {
    double cor_Id_Iso_Mu = Cor_FR_ID_Iso_Mu_Tight_2012(a);
    //double cor_Trg_Mu = Eff_HLT_Mu17_Mu8_2011_TPfit_RunAB_EtaEta_DATAoverMC(a);
...
double Cor_FR_Total_Mu_Loose_2012(myobject const& a) {
    double cor_Id_Iso_Mu = Cor_FR_ID_Iso_Mu_Loose_2012(a);
    //double cor_Trg_Mu = Eff_HLT_Mu17_Mu8_2011_TPfit_RunAB_EtaEta_DATAoverMC(a);
...
double Cor_FR_Total_Mu_Loose_2012_53X(myobject const& a) {
    double cor_Id_Iso_Mu = Cor_FR_ID_Iso_Mu_Loose_2012_53X(a);
    //double cor_Trg_Mu = Eff_HLT_Mu17_Mu8_2011_TPfit_RunAB_EtaEta_DATAoverMC(a);
