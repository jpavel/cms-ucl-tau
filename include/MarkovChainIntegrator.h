...
class MarkovChainIntegrator
{
 public:
  ...
  MarkovChainIntegrator(std::string name, std::string mode, std::string initMode, unsigned numIterBurnin,
unsigned numIterSampling, unsigned maxCallsStartingPos, unsigned numIterSimAnnealingPhase1, unsigned numIterSimAnnealingPhase2,
double T0, double alpha, unsigned numChains, unsigned numBatches, unsigned L, double epsilon0, bool useVarEpsilon0 ,double nu , int verbosity);
  ~MarkovChainIntegrator();
